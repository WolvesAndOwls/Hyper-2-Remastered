...
/obj/item/clothing/head/helmet/titan
	name = "titans helmet"
	desc = "An intimidating, massive tribal helmet, forged from the skull of some massive creature, reinforced with additional bone plating, padded with goliath hide and held together with watcher sinew, this will be hard to break through."
	...
	icon_state = "skull"
	item_state = "skull"
	var/hit_reflect_chance = 80
	strip_delay = 100
	mutantrace_variation = MUTANTRACE_VARIATION

/obj/item/clothing/head/helmet/skull
	name = "skull helmet"
	desc = "An intimidating tribal helmet."
	flags_inv = HIDEMASK|HIDEEARS|HIDEEYES|HIDEFACE
	flags_cover = HEADCOVERSEYES
