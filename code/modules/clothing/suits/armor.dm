...
/obj/item/clothing/suit/armor/titan
	name = "titan armor"
	desc = "A monstrous set of tribal plate armor, crafted from bones, with additional padding from goliath hides and watcher sinew, along with smelted diamonds and ash coating the exterior, despite it's primitive origins, this suit will be hard to break."
	icon_state = "bonearmor"
	item_state = "bonearmor"
