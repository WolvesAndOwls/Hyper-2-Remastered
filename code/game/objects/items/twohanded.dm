...
/obj/item/twohanded/fireaxe/titan  // Blatant imitation of the fireaxe, but made out of bone.
	icon_state = "bone_axe0"
	name = "titans axe"
	desc = "A viscious beast of an axe, sharpened to utter perfection and extremely heavy, a single strike from this will devastate almost anyone."
	force_unwielded = 30
	force_wielded = 60
	armour_penetration = 100
	block_chance = 75
	throwforce = 100
	throw_speed = 10
	attack_verb = list("shredded", "crushed", "annihilated", "obliterated")

/obj/item/twohanded/fireaxe/titan/update_icon()
	icon_state = "bone_axe[wielded]"
